(function () {
  ...
  var buttonOrigPos = [];
  var textOrigPos = [];
  var normalButtonImg = 'file:///../download0/themes/transformers/img/botonNormal.png';
  var selectedButtonImg = 'file:///../download0/themes/transformers/img/botonSelecionado.png';
  ...
  if (typeof startBgmIfEnabled === 'function') {
    startBgmIfEnabled();
  }  if (typeof jsmaf.bgm === 'undefined') {    jsmaf.bgm = new jsmaf.AudioClip();    jsmaf.bgm.volume = 0.5;    jsmaf.bgm.open('file://../download0/themes/transformers/img/bgm.wav');	jsmaf.bgm.play(true);  }  var bgm = jsmaf.bgm;
  var background = new Image({
    url: 'file:///../download0/themes/transformers/img/Fondo.jpg',
    x: 0,
    y: 0,
    width: 1920,
    height: 1080
  ...
  var logoHeight = 338;
  var logo = new Image({
    url: 'file:///../download0/themes/transformers/img/Logo.png',
  ...
  for (var i = 0; i < menuOptions.length; i++) {
    ...
    if (useImageText) {
      ...
      btnText.x = btnX + 20;
      btnText.y = btnY + buttonHeight / 2 - 26 / 2;
      btnText.style = 'white';
    }
  ...
  if (useImageText) {
    ...
    exitText.x = exitX + 20;
    exitText.y = exitY + buttonHeight / 2 - 26 / 2;
